...
STRESS_TEMPLATES: Dict[str, Dict[str, object]] = {
    "external_help": {
        "keywords": "外面|外界|朋友|同伙|接应|哈奇|兰塞姆|球场|孩子|记者|电工",
        "assumption": "方案依赖牢房外有人稳定接收并执行信息。",
        "question": "如果外部接收者暂时不存在，你的方案如何启动？",
        "preferred_evidence_ids": ["E05", "E08"],
    },
    "hidden_tool": {
        "keywords": "工具|锉刀|钢片|鞋跟|牙粉|墨水|笔|钞票|酸|硝酸|钢钳|电线",
        "assumption": "方案依赖教授已经拥有足够工具或材料。",
        "question": "这些工具是入狱时带入、牢内制造，还是后来进入的？",
        "preferred_evidence_ids": ["E02", "E03", "E10"],
    },
    "physical_path": {
        "keywords": "排水管|管道|圆孔|老鼠|洞|河|爬出去|钻出去|通道",
        "assumption": "方案把排水管当成完整逃生路径。",
        "question": "如果成人不能通过排水管，它还能承担什么作用？",
        "preferred_evidence_ids": ["E06", "E07", "E09"],
    },
    "deception": {
        "keywords": "假装|伪装|误导|声东击西|骗|装作|假人|布条|贿赂",
        "assumption": "方案依赖某些行动是在诱导狱方误判。",
        "question": "哪些行动是真正推进计划，哪些只是让狱方看见？",
        "preferred_evidence_ids": ["E08", "E12", "E14"],
    },
    "unknown": {
        "keywords": "",
        "assumption": "方案中至少有一个关键环节还没有被已读文本支持。",
        "question": "你的解释里哪一步来自原文，哪一步只是当前猜测？",
